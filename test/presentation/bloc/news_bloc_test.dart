...
void main() {
  ...
  NewsEntity tNews = NewsEntity(num_results: 10, copyright: "test", status: "true", results: []);
  ...
  blocTest<NewsBloc, NewsState>(
    ...
    act: (bloc) => bloc.add(GetNewsEvent("home")),
      ...
      return [
        NewsState(
          (b) => b
            ...
            ..isSearch = false
            ..isChanged = false
            ..newsEntity = NewsEntity(status: "", copyright: "", num_results: 0, results: [])
            ..newsResult = NewsEntity(status: "", copyright: "", num_results: 0, results: [])
            ..errorMessage = '',
        ),
        newsBloc.state
      ];
    ...
    verify: (bloc) {
      verifyNever(mockGetCurrentNews.call(Params("home")));
    },
  );
  ...
  blocTest<NewsBloc, NewsState>(
    ...
    build: () {
      when(mockGetCurrentNews.call(any)).thenAnswer((_) async => const Left(ServerFailure(Er.error)));
      return newsBloc;
    },
    act: (bloc) => bloc.onGetNews("home"),
    wait: const Duration(milliseconds: 500),
    expect: () {
      return [
        NewsState(
  ...
  blocTest<NewsBloc, NewsState>(
    ...
    seed: () => NewsState(
      (b) => b
        ...
        ..isChanged = true
        ..errorMessage = ''
        ..newsEntity = NewsEntity(status: "", copyright: "", num_results: 0, results: [NewsDataModel(title: "te", abstract: "queen",byline: "Ali")])
        ..newsResult = NewsEntity(status: "", copyright: "", num_results: 0, results: [NewsDataModel(title: "te", abstract: "queen",byline: "Ali")]),
    ),
    act: (bloc) => bloc.onSearchNewsEvent("Ali"),
    expect: () => [
      NewsState(
        (b) => b
          ..isLoading = false
  ...
  blocTest<NewsBloc, NewsState>(
    ...
    seed: () => NewsState(
      (b) => b
        ...
        ..isChanged = false
        ..errorMessage = ''
        ..newsEntity = NewsEntity(status: "", copyright: "", num_results: 0, results: [NewsDataModel(title: "te", abstract: "queen")])
        ..newsResult = NewsEntity(status: "", copyright: "", num_results: 0, results: []),
    ),
